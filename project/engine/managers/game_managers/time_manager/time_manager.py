...
from project.engine.managers.game_managers.time_manager.timer import Timer
    ...
    def update(self, dt):
        ...
        for timer in self.timers[:]:
            ...
            if not timer.active:
                ...
                if timer.repeat:
                    to_add.append(
                        Timer(self.main, self.main.manager.window_manager.time, timer.duration, timer.event, timer.data,
                              timer.repeat))
