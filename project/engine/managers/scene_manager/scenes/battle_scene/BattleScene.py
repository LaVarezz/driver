...
from project.engine.managers.scene_manager.scenes.battle_scene.map.map import BattleMap
...
class BattleScene():
    def __init__(self, main: MainLike):
        ...
        self.battle_map = BattleMap(map_size=self.main.settings.game_settings['battle_map_size'], tile_size=tile_size,
