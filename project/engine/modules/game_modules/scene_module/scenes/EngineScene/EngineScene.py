...
class EngineScene:
    ...
    def update(self):
        if self.main.modules.engine_module.able_to_change:
            if self.main.modules.widget_module.hovered_id and self.main.modules.widget_module.hovered_id == self.main.modules.widget_module.captured_id:
                widget = self.main.modules.widget_module.get_widget(self.main.modules.widget_module.hovered_id)
    ...
    def can_replace_widget(self, widget, dx, dy):
        if not widget.panel:
           ...
           pan = self.main.modules.widget_module.get_widget(widget.panel)
           wg = pan.width
           hg = pan.height
